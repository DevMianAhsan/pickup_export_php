...
<form action="php_action/custom_action.php" method="POST" role="form" id="personeForm">
		<input type="hidden" name="trade_type" value="company">
			...
			<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-sm-3">
						...
						<button type="button" class="btn btn-info" onclick="refresh_select(`auction_house2`,`auction_home_id`,`auction_home_name`,``,``)"><span class="fa fa-refresh" ></span></button>
					</div><!-- col -->
				</div><!-- inner row -->
			...
			<div class="form-group">
				...
				<div class="row">
					...
					<div class="col-sm-4">
						...
						<label for="">POS Nmmber</label>

					</div><!-- col -->

					<div class="col-sm-8">			

						<input type="text"  name="posnumber2" id="posnumber2" class="form-control" >
				...
				<div class="row">
					...
					<div class="col-sm-8">			
							...
							<textarea readonly name="companyname" id="companyname" class="form-control">
							</textarea>
					</div><!-- col -->
