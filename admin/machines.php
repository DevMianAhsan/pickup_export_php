      ...
      <div class="card">
            ...
            <div class="vehicel_main_form">
              ...
              <div class="row form-group">
                ...
                <div class="col-sm-3">
                  ...
                  <select class="form-control select2" tabindex="2" name="machine_maker"
                    onchange="loadBrands(this.value)" id="machine_maker" class="form-control abcCustomNew vehicle_maker"
                    required="required">
                    ...
                    while ($r = mysqli_fetch_assoc($q)): ?>
                      ...
                      <option <?= @($PartDe['machine_maker'] == $r['maker_id']) ? "selected" : "" ?> value="<?= $r['maker_id'] ?>">
                        <?= strtoupper($r['maker_name']) ?></option>
                ...
                <div class="col-sm-3">
                  ...
                  <select class="form-control select2" tabindex="3" name="machine_brand"
                    onchange="loadChassis(this.value)" id="vehicle_brand" class="form-control fuckJS vehicle_brand"
                    required="required">
                ...
                <div class="col-sm-2">
                  ...
                  <select class="form-control select2" tabindex="2" name="machine_type" id="machine_type"
                    class="form-control abcCustomNew vehicle_machine" required="required">
                    ...
                    while ($r = mysqli_fetch_assoc($q)): ?>
                      ...
                      <option <?= @($PartDe['machine_type'] == $r['machine_type_id']) ? "selected" : "" ?>
                        value="<?= $r['machine_type_id'] ?>"><?= strtoupper($r['machine_type_name']) ?></option>
        ...
        <select  name="machine_cc" id="machine_cc" class="form-control select2" required="required">
         ...
         <option value="">Select</option>
          ...
          <? php// endwhile ?>-->
              ...
              <div class="row">
                <div class="col-sm-2">
                  ...
                  <input type="text" value="<?= @$PartDe['part_no'] ?>" name="part_no" id="part_no"
                    class="form-control  part_no">
                </div>
                <div class="col-sm-3">
                  <label for="">Color</label>
                  <input name="machine_color" value="<?= @$PartDe['machine_color'] ?>" id="machine_color"
                    class="form-control">
                </div>
                <div class="col-sm-3">
                  <label for="">Year</label>
                  <select class="form-control select2" name="machine_year" id="machine_year"
                    class="form-control machine_reg_month" required="required" onchange="validateyears()">
                    <option value="">~~SELECT~~</option>
                    <?php
                ...
                <div class="col-sm-2">
                  ...
                  <select class="form-control select2" name="machine_manu_year" id="machine_manu_year"
                ...
                <div class="col-sm-2">
                  ...
                  <input value="<?= @$PartDe['machine_serial_no'] ?>" name="machine_serial_no" id="machine_serial_no"
              ...
              <div class="row">
                <div class="col-sm-2">
                  ...
                  <input value="<?= @$PartDe['machine_weight'] ?>" name="machine_weight" id="machine_weight"
                    class="form-control" autocomplete="off">
                </div>
                <div class="col-sm-3">
                  ...
                  <select list="machine_fuel1" name="machine_fuel" id="machine_fuel" class="form-control select2">
                    ...
                    while ($r = mysqli_fetch_assoc($q)): ?>
                      ...
                      <option <?= @(strtolower($PartDe['machine_fuel']) == strtolower($r['fuel_name'])) ? "selected" : "" ?>
                ...
                <div class="col-sm-3">
                  ...
                  <input value="<?= @$PartDe['machine_fob_price'] ?>" name="machine_fob_price" id="machine_fob_price"
                ...
                <div class="col-sm-2">
                  ...
                  <select name="machine_steering" id="machine_steering" class="form-control select2">
                    ...
                    while ($r = mysqli_fetch_assoc($q)): ?>
                      ...
                      <option <?= (strtoupper(@$PartDe['machine_steering']) == strtoupper($r['option_name'])) ? "selected" : "" ?>
                ...
                <div class="col-sm-2 m-0 p-0">
                  ...
                  <input placeholder="L" style="width: 30% !important; display: inline-block; "
                    value="<?= @$PartDe['machine_l'] ?>" name="machine_l" id="machine_l" class="form-control m-0 p-0"
                    autocomplete="off">
                  <input placeholder="W" style="width: 30% !important; display: inline-block; "
                    value="<?= @$PartDe['machine_w'] ?>" name="machine_w" id="machine_w" class="form-control m-0 p-0"
                    autocomplete="off">
                  <input placeholder="H" style="width: 30% !important; display: inline-block; "
                    value="<?= @$PartDe['machine_h'] ?>" name="machine_h" id="machine_h" class="form-control m-0 p-0"
                    autocomplete="off">
                </div>
              </div><!-- mian -->
              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  ...
                  <input value="<?= @$PartDe['machine_drive'] ?>" name="machine_drive" id="machine_drive"
                    class="form-control" autocomplete="off" required>
                </div>
                <div class="col-sm-3">
                  <label for="">Transmission</label>
                  <input value="<?= @$PartDe['machine_transmission'] ?>" name="machine_transmission"
                    id="machine_transmission" class="form-control" autocomplete="off" required>
                </div>
                <div class="col-sm-3">
                  <label for="">Condition</label>
                  <input value="<?= @$PartDe['machine_condition'] ?>" name="machine_condition" id="machine_condition"
                    class="form-control" autocomplete="off" required>
                </div>
              </div><!-- row -->
              ...
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <textarea name="machine_note" placeholder="Parts Description" id="machine_note" class="form-control"
                    rows="2"><?= @$PartDe['machine_note'] ?></textarea>
                </div>
                <div class="col-sm-6">
                  <label for="">Condition Remarks</label>
                  <textarea name="machine_condition_remarks" placeholder="Condition Remarks"
                    id="machine_condition_remarks" class="form-control"
                    rows="2"><?= @$PartDe['machine_condition_remarks'] ?></textarea>
                </div>
              </div><!-- row -->
          ...
          <form action="php_action/custom_action.php" class="dropzone " id="dropzoneFrom" method="post"
          ...
          <div class="row">
            <div class="col-sm-6">
              <button type="button" class="btn btn-success btn-sm float-right" id="reloadimg"
                onclick="reloaded()">Reload</button>
            </div>
            <div class="col-sm-4">
