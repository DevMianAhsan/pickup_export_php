...
echo json_encode($response);
	...
	if (isset($_POST['loadVehicle']) && isset($_POST['loadVehicle']) != "") {
		...
		$q = mysqli_query($dbc,"SELECT vehicle_info.*,brands.*,models.* FROM vehicle_info LEFT JOIN brands ON brands.brand_id = vehicle_info.vehicle_brand LEFT JOIN models ON models.model_id = vehicle_info.vehicle_chassis_code WHERE vehicle_info.vehicle_id = $id ");
