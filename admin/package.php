...
<!-- start page content -->
			...
			<div class="col-sm-12">
				<div class="panel">
					<div class="panel-heading panel-heading-red" align="center"><h4>Create Package</h4></div>
						<div class="panel-body">
							<form action="php_action/custom_action.php" method="POST" role="form" id="formData">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control d-none" id="pack_id" name="pack_id"> 
								</div>
								<div class="form-group">
									<label for="">Package Status</label>
									<select class="form-control select2" id="pack_sts" name="pack_sts"> 
...
<div class="col-sm-12">
		<div class="panel">
	<div class="panel-heading cyan-bgcolor" align="center"><h4>Package</h4></div>
	<div class="panel-body">
