...
<!-- 		<ol class="breadcrumb">
		...
		<div class="panel">
			<div class="panel-heading panel-heading-blue">
				<div class="page-heading"> <i class="fa fa-edit"></i> Manage Categories</div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-primary button1" data-toggle="modal" id="addCategoriesModalBtn" data-target="#addCategoriesModal"> <i class="fa fa-plus"></i> Add Categories </button>
				</div> <!-- /div-action -->				
				<br><br>
